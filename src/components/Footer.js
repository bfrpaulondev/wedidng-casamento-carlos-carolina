...
Carolina & Carlos — Desenvolvido por{' '}
        <link href="{&#x60;https://api.whatsapp.com/send?phone=${phoneNumber}&#x26;text=${encodeURIComponent(whatsappMessage)}&#x60;}" target="_blank" rel="noopener noreferrer" underline="hover" color="inherit">
          @Bfrpaulondev  
  );
}
